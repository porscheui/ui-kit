...
import { type Theme, iconOverrides, themeQuartz } from 'ag-grid-community';
  ...
  .withParams(
    {
      ...
      checkboxCheckedBackgroundColor: themeDarkPrimary, // checkbox-checked-color: $pds-theme-light-primary,
      checkboxCheckedBorderColor: themeDarkPrimary,
      checkboxUncheckedBorderColor: themeDarkContrastMedium,
      checkboxIndeterminateBackgroundColor: themeDarkBackgroundBase, // checkbox-indeterminate-color: $pds-theme-light-background-base,
  ...
  .withParams(
    {
      ...
      checkboxCheckedBackgroundColor: themeLightPrimary, // checkbox-checked-color: $pds-theme-light-primary,
